package com.badr.blog.config;

import com.badr.blog.domain.entities.User;
import com.badr.blog.repositories.UserRepository;
import com.badr.blog.security.BlogUserDetailsService;
import com.badr.blog.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService(UserRepository userRepository) {
        ...
        // Create a user if he did not exist in our DB (Shouldn't be in prod)
